...
func _enter_tree() -> void:
	...
	add_custom_type("BuffHandler", "Node", preload("res://addons/gd_buffmanager/Buff/BuffHandler.gd"), EditorInterface.get_base_control().get_theme_icon("Node", "EditorIcons"))
